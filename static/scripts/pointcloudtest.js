...
(function() {
	...
	We're about to get loopy.	*/
        ...
        var sprite1 = textureLoader.load( '/static/images/star.png' );
        ...
        parameters = [
            ...
            [
                [0.95, 1, 0.5], 4, sprite1
            ],
            [
                [0.90, 1, 0.5], 3, sprite1
            ],
            [
                [0.85, 1, 0.5], 2, sprite1
            ],
            [
                [0.80, 1, 0.5], 1, sprite1
            ]
        ];
	...
	Clean that vommit up, we're going again!	*/
        ...
        for (i = 0; i < parameterCount; i++) {
            ...
            color = [Math.random(0, 1), 1, 0.5]; // parameters[i][0];
            size = 5; // parameters[i][1];
